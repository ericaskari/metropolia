...
function articleBuilder(header, caption, imageLink, imageDescription) {
    return `
        <article>
            <header>
                <h2>${header}</h2>
...
document.addEventListener("DOMContentLoaded", () => {
...

    {
        ...
        main.innerHTML = picArray.map(image => articleBuilder(image.title, image.caption, image.filename, image.description)).join('\n');
    }
});
