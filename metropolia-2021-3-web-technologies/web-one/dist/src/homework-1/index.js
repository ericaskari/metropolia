"use strict";
{
    ...
    function section2() {
        const startSectionTwoButton = document.querySelector('#start-section-2-button');
    ...
    function section3() {
        const startSectionThreeButton = document.querySelector('#start-section-3-button');
        const circleAreaOutputEl = document.querySelector('#circle-area-output');
        ...
        startSectionThreeButton.onclick = (event) => {
    ...
    function section4() {
        const startSectionThreeButton = document.querySelector('#start-section-4-button');
        const rectangleCircuitOutputEL = document.querySelector('#rectangle-circuit-output');
        const rectangleAreaOutputEL = document.querySelector('#rectangle-area-output');
    ...
    function section5() {
        const startSectionThreeButton = document.querySelector('#start-section-5-button');
        const sumOutputEl = document.querySelector('#section-5-sum-output');
        const multiplicationOutputEl = document.querySelector('#section-5-tulo-output');
        const averageOutputEl = document.querySelector('#section-5-keskiarvo-output');
        if (!sumOutputEl) {
    ...
    function section6() {
        const startSectionButton = document.querySelector('#start-section-6-button');
        ...
        startSectionButton.onclick = () => {
            ...
            const sum = leiviskaInGram + nauloInGram + luotiInGram;
    ...
    function section7() {
        const startSectionButton = document.querySelector('#start-section-7-button');
        const outputInterestEl = document.querySelector('#section-7-output-interest');
        const outputBalanceEl = document.querySelector('#section-7-output-balance');
        if (!outputInterestEl) {
    ...
    function section8() {
        const rollDiceButtonEl = document.querySelector('#roll-dice-button');
        const diceOneOutputEl = document.querySelector('#section-8-output-dice-1');
        const diceTwoOutputEl = document.querySelector('#section-8-output-dice-2');
        const diceSumOutputEl = document.querySelector('#section-8-output-dice-sum');
        if (!rollDiceButtonEl) {
    ...
    function section9() {
        ...
        const codeOutput1El = document.querySelector('#section-9-output-1');
        const codeOutput2El = document.querySelector('#section-9-output-2');
        if (!generateBtnEl) {
